...
interface SignalPanelProps {
  ...
  dataSourceInfo?: { source: DataSource; oiSource: 'nse' | 'synthetic'; lastUpdated: number };
}
...
function DataSourceBadge({ source, oiSource }: { source: DataSource; oiSource: 'nse' | 'synthetic' }) {
  return (
